...
exports.Select = base_1.createComponent(function Select(props, ref) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(base_1.Tag, tslib_1.__assign({ role: "listbox" }, rootProps, { element: rootEl, ref: ref, className: className }),
            ...
            enhanced && (react_1.default.createElement(EnhancedMenu, tslib_1.__assign({}, rest, { anchorCorner: "bottomStart", defaultValue: defaultValue, placeholder: placeholder, open: menuOpen, onClose: handleMenuClosed, onOpen: handleMenuOpened, onSelect: function (evt) {
