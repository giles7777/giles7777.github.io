...
exports.useListFoundation = function (props) {
    var listElements = react_1.useCallback(function (el) {
        if (el) {
            return [].slice.call(el.querySelectorAll("." + list_1.MDCListFoundation.cssClasses.LIST_ITEM_CLASS));
        }
        return [];
    }, []);
    var _a = base_2.useFoundation({
        ...
        api: function (_a) {
            ...
            return {
                ...
                getClasses: function () { return list_1.MDCListFoundation.cssClasses.LIST_ITEM_CLASS; },
     ...
     */
    var getListItemIndex = react_1.useCallback(function (evt) {
    ...
    var handleFocusIn = react_1.useCallback(function (evt) {
        var _a;
    ...
    var handleFocusOut = react_1.useCallback(function (evt) {
        var _a;
