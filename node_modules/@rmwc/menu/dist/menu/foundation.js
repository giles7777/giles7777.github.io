...
exports.useMenuFoundation = function (props) {
    ...
    react_1.useEffect(function () {
        if (listApi.current && menuSurfaceApi.current && props.apiRef) {
            props.apiRef(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, listApi.current), menuSurfaceApi.current), { items: items }));
        }
        // eslint-disable-next-line
    }, [canSetApi, items]);
    return tslib_1.__assign({ setListApi: setListApi, setMenuSurfaceApi: setMenuSurfaceApi }, elements);
};
