...
exports.MenuSurface = base_1.createComponent(function MenuSurface(props, ref) {
    ...
    var rootEl = foundation_1.useMenuSurfaceFoundation(props).rootEl;
    ...
    return (react_1.default.createElement(base_2.PortalChild, { renderTo: renderToPortal },
        react_1.default.createElement(base_1.Tag, tslib_1.__assign({}, rest, { element: rootEl, className: className, ref: ref }), children)));
});
