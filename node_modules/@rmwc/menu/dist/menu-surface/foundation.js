...
exports.useMenuSurfaceFoundation = function (props) {
    ...
    var _b = base_1.useFoundation({
        ...
        foundation: function (_a) {
            ...
            var f = new menu_surface_1.MDCMenuSurfaceFoundation(tslib_1.__assign(tslib_1.__assign({ addClass: function (className) {
    ...
    react_1.useEffect(function () {
        if (open) {
            var focusableElements = rootEl.ref
                ? rootEl.ref.querySelectorAll(menu_surface_1.MDCMenuSurfaceFoundation.strings.FOCUSABLE_ELEMENTS)
                : [];
