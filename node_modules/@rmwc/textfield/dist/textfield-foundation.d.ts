...
export declare const useTextFieldFoundation: (props: TextFieldProps) => {
    ...
    setLeadingIcon: (api: TextFieldIconApi) => TextFieldIconApi;
    setTrailingIcon: (api: TextFieldIconApi) => TextFieldIconApi;
    setFloatingLabel: (api: FloatingLabelApi) => FloatingLabelApi;
};
