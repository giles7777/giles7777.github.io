 ...
 */
export declare const withRipple: ({ unbounded: defaultUnbounded, accent: defaultAccent, surface: defaultSurface }?: WithRippleOpts) => <P extends any, C extends React.ComponentType<P>>(Component: C) => C;
export {};
